...
import com.personali.kafka.connect.cloud.storage.partition.CustomDateFormatStoragePartition;
import com.personali.kafka.connect.cloud.storage.partition.StoragePartition;
import com.personali.kafka.connect.cloud.storage.storage.S3StorageWriter;
...
public class S3WriterTest extends TestCase {
  ...
  public void testUpload() throws Exception {
    ...
    config.put("s3.bucket",testBucket);
    StorageWriter s3Writer = new S3StorageWriter(config, s3Mock, tmMock);
    ...
    StoragePartition tpKey = new CustomDateFormatStoragePartition(record,config);
  ...
  public void testFetchOffsetNewTopic() throws Exception {
    ...
    config.put("s3.bucket",testBucket);
    StorageWriter s3Writer = new S3StorageWriter(config, s3Mock, null);
